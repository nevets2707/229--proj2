...
ssbros : ssbros.cpp OtherActors.o simplehero.o SmartPowerup.o Pos.o
	g++ -g -Wall -o ssbros ssbros.cpp Actor.o GraphMap.o GameManager.o OtherActors.o Pursuer.o simplehero.o SmartPowerup.o Pos.o -lncurses
